...
# asy1 = Asy.link(network_list, diversity = 'TD', q = c(0,1,2),nboot = 0)
...
spec1 = Spec.link(network_list, q = seq(0,2,1), datatype = "abundance", nboot =0)
...
asy2 = Asy.link(network_list, diversity = 'PD', q = seq(0,2,0.25),nboot = 0, 
                col.tree = coltree, row.tree = rowtree)
obs2 = Obs.link(network_list, diversity = 'PD', q = seq(0,2,0.25),nboot = 0,
                col.tree = coltree, row.tree = rowtree)
```
