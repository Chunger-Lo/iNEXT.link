...
### 3. Empirical / Asymptotic diversity
...
even1 = NetEvenness(Norfolk, q = seq(0,2,1), datatype = "abundance", nboot =30)
```
...
dissimilarity1 = iNEXT_beta_link(x = Norfolk, coverage_expected = seq(0.5,1,0.05),
                                 ...
                                 nboot = 30, conf = 0.95, max_alpha_coverage=F, by='coverage')
```
...
```{r}
asy2 = AsyPND(puerto.rico$data, q = c(0,1,2), nboot = 10)
obs2 = ObsPND(puerto.rico$data, q = c(0,1,2), nboot = 10)
...
```{r}
even2 = NetEvenness(puerto.rico$data, q=  seq(0,2,1), datatype = "abundance", nboot = 0, E = 1:5, method = "Estimated", C = 0.9)
```
