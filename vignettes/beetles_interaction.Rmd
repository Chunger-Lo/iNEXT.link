...
```{r}
datainf_pool = DataInfo.link(data = beetles_plot_treat$data, 
                        diversity = 'TD', datatype = "abundance")
datainf_pool%>%
  flextable()
...
# Beta
dissimilarity_pool = iNEXTbeta.link(data = beetles_pool$data, level = seq(0.5,0.95,0.05),
                                    datatype='abundance',q = c(0, 1, 2), diversity='TD',
                                    nboot = b, conf = 0.95)

dissimilarity_byplot = iNEXTbeta.link(data = beetles_plot_treat$data, level = seq(0.5,0.95,0.05),
                                      datatype='abundance',q = c(0, 1, 2),diversity='TD',
                                 nboot = b, conf = 0.95)

dissimilarity_bytreat = iNEXTbeta.link(data = beetles_treat_plot$data, level = seq(0.5,0.95,0.05),
                                       datatype='abundance',q = c(0, 1, 2),diversity='TD',
                                       nboot = b, conf = 0.95)
...
```{r, message = F, warning=F}
b =50
datainf_phy = DataInfo.link(data = beetles_pool$data, diversity = 'PD', datatype = "abundance",
