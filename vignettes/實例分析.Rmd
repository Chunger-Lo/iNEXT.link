...
inext = iNEXT.link(x = Norfolk, class = 'TD', datatype = "abundance", nboot = 30)
asy = Asy.link(data = Norfolk, class = 'TD', datatype = "abundance", nboot = 30)
```
...
```{r fig.height=4, fig.width=6}
inext$TDiNextEst$coverage_based
ggiNEXT.link(inext)

iNEXT3D::ggiNEXT3D(inext,type = 2)
```
